...
> **_NOTE:_**  Quarkus now ships with a Dev UI, which is available in dev mode only at http://localhost:8085
...
You can then execute your native executable with: `./target/peanut-with-quarkus-1.0.0-SNAPSHOT-runner`
